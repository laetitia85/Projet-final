      ...
      <div class="bgcolorform">
        ...
        <div>
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> met à
          ...
          <p>
            ...
            d’être détenues par
            <a href="http://localhost:8080">http://localhost:8080</a> pour la
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> l'identité
            des différents intervenants dans le cadre de sa réalisation et de
            son suivi:
          </p>
          <p>
            <strong>Propriétaire</strong> : Laetitia de Bardin – 1 Avenue
            Edouard Vaillant 92150 Suresnes<br />

            <strong>Responsable publication</strong> : Laetitia de Bardin –
            laetitia.artisteAndpro@gmail.com<br />
            Le responsable publication est une personne physique ou une personne
            morale.<br />
            <strong>Webmaster</strong> : Laetitia de Bardin –
            laetitia.artisteAndpro@gmail.com<br />
            <strong>Hébergeur</strong> : Laetitia – 1 Avenue Edouard Vaillant
            92150 Suresnes 0614152619<br />
            <strong>Délégué à la protection des données</strong> : Laetitia de
            Bardin – titiluna.sky85@gmail.com<br />
          </p>
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> implique
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> sont donc
          ...
          <p>
            Le site internet
            <a href="http://localhost:8080">http://localhost:8080</a> a pour
            objet de fournir une information concernant l’ensemble des activités
            de la société.
            <a href="http://localhost:8080">http://localhost:8080</a> s’efforce
            de fournir sur le site
            <a href="http://localhost:8080">http://localhost:8080</a> des
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> sont
            données à titre indicatif, et sont susceptibles d’évoluer. Par
            ailleurs, les renseignements figurant sur le site
            <a href="http://localhost:8080">http://localhost:8080</a> ne sont
          ...
          <p>
            ...
            site <a href="http://localhost:8080">http://localhost:8080</a> est
          ...
          <p>
            <a href="http://localhost:8080">http://localhost:8080</a> et
          ...
          <p>
            <a href="http://localhost:8080">http://localhost:8080</a> est
          ...
          <p>
            <a href="http://localhost:8080">http://localhost:8080</a> agit en
          ...
          <p>
            <a href="http://localhost:8080">http://localhost:8080</a> ne pourra
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> se réserve
          ...
          <p>
            ...
            est : Laetitia de Bardin.
            <a href="http://localhost:8080">http://localhost:8080</a>est
            représenté par Laetitia de Bardin, son représentant légal
          </p>

          <p>
            En tant que responsable du traitement des données qu’il collecte,
            <a href="http://localhost:8080">http://localhost:8080</a> s’engage à
            ...
            fois que
            <a href="http://localhost:8080">http://localhost:8080</a> traite des
            Données Personnelles,
            <a href="http://localhost:8080">http://localhost:8080</a> prend
            ...
            lesquelles
            <a href="http://localhost:8080">http://localhost:8080</a> les
            traite.
          </p>
          ...
          <p>
            <a href="http://localhost:8080">http://localhost:8080</a> ne
          ...
          <p>
            ...
            Utilisateurs de
            <a href="http://localhost:8080">http://localhost:8080</a> disposent
            des droits suivants :
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              <a href="http://localhost:8080">http://localhost:8080</a> devra
          ...
          <p>
            Dès que <a href="http://localhost:8080">http://localhost:8080</a> a
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> utilise
            ses Données Personnelles, demander à les rectifier ou s’oppose à
            leur traitement, l’Utilisateur peut contacter
            <a href="http://localhost:8080">http://localhost:8080</a> par écrit
            à l’adresse suivante :
          </p>

          Laetitia de Bardin – DPO, Laetitia de Bardin <br />
          1 Avenue Edouard Vaillant 92150 Suresnes.

          <p>
            Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles
            qu’il souhaiterait que
            <a href="http://localhost:8080">http://localhost:8080</a> corrige,
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> par la
            loi, notamment en matière de conservation ou d’archivage des
            documents. Enfin, les Utilisateurs de
            <a href="http://localhost:8080">http://localhost:8080</a> peuvent
          ...
          <p>
            <a href="http://localhost:8080">http://localhost:8080</a> s’interdit
            de traiter, héberger ou transférer les Informations collectées sur
            ses Clients vers un pays situé en dehors de l’Union européenne ou
            reconnu comme « non adéquat » par la Commission européenne sans en
            informer préalablement le client. Pour autant,
            <a href="http://localhost:8080">http://localhost:8080</a> reste
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a>, celle-ci
          ...
          <p>
            ...
            des filiales de
            <a href="http://localhost:8080">http://localhost:8080</a> et des
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> n'est
            ...
            rachat de
            <a href="http://localhost:8080">http://localhost:8080</a> et de ses
          ...
          <p>
            Le site
            <a href="http://localhost:8080">http://localhost:8080</a> contient
            un certain nombre de liens hypertextes vers d’autres sites, mis en
            place avec l’autorisation de
            <a href="http://localhost:8080">http://localhost:8080</a>.
            Cependant,
            <a href="http://localhost:8080">http://localhost:8080</a> n’a pas la
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> informe
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> ou l’un de
          ...
          <p>
            Le cas échéant,
            <a href="http://localhost:8080">http://localhost:8080</a> décline
            ...
            <a href="http://localhost:8080">http://localhost:8080</a>, résultant
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> pourra en
            outre faire appel aux services de prestataires externes pour l’aider
            à recueillir et traiter les informations décrites dans cette
            section.
          </p>
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> ou dans
            ...
            <a href="http://localhost:8080">http://localhost:8080</a>, Twitter,
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a>. À tout
            moment, l’Utilisateur peut néanmoins revenir sur son consentement à
            ce que
            <a href="http://localhost:8080">http://localhost:8080</a> dépose ce
            type de cookies.
          </p>
          ...
          <p>
            <a href="http://localhost:8080">http://localhost:8080</a> peut
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> d’évaluer
          ...
          <p>
            ...
            <a href="http://localhost:8080">http://localhost:8080</a> est soumis
