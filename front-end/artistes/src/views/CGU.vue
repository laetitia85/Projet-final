...
<p>En vigueur au 27/04/2021</p>
<p>Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet de définir les
...
localhost:8080 se réserve le droit de modifier unilatéralement et à tout moment le contenu des
présentes CGU.</p>
<h2>Article 1 : Les mentions légales</h2>
<p>L’édition et la direction de la publication du site localhost:8080 est assurée par Laetitia de Bardin,
domicilié au 1 Avenue Edouard Vaillant.
<!-- Numéro de téléphone : 0614152619 <br> -->
Adresse e-mail : laetitia.artisteAndpro@gmail.com.</p>
<!-- L'hébergeur du site localhost:8080 est la société _______________, dont le siège social est situé au
_______________, avec le numéro de téléphone : _______________.</p> -->
<h2>ARTICLE 2 : Accès au site</h2>
<p>Le site localhost:8080 permet à l'Utilisateur un accès gratuit aux services suivants :<br>
Le site internet propose les services suivants :<br>
Utilisateurs Artistes :<br>
 => Poster leurs créations artistiques<br>
 <ul>
 <li>Chanson</li>
 <li>Texte</li>
 <li>Composition</li>
 </ul>
 => Y avoir accès pour les visualiser et/ou supprimer.<br><br>
Utilisateurs Professionnels :<br>
<ul>
 <li>Visualiser les créations artistiques</li>
 <li>Laisser des commentaires</li>
 <li>Prendre contact avec le(s) utilisateur(s) artiste(s)</li>
 </ul><br>
...
la responsabilité de localhost:8080. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à
...
<p>Les sources des informations diffusées sur le site localhost:8080 sont réputées fiables mais le site ne
...
Malgré des mises à jour régulières, le site localhost:8080 ne peut être tenu responsable de la
...
Le site localhost:8080 ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter
...
liens, il sortira du site localhost:8080. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles
...
l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site localhost:8080. Les
...
L’information contenue dans les cookies est utilisée pour améliorer le site localhost:8080.<br>
...
œuvres personnelles , commentaires.<br>
